;; Found at http://www.emacswiki.org/emacs/PersonalDiary
...
'applications)
(defcustom journal-dir "~/journal/" "Directory containing journal entries"
...
(defun journal-new-entry nil "Open today's journal file and start a new entry"
  ...
  (find-file (concat journal-dir (format-time-string "%Y-%m-%d-%a")))
